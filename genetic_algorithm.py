...
def genetic_algorithm(key_length, number_of_generations, cipher_text, mutation_rate=0.2):
    """
...
if __name__ == '__main__':
    ...
    print(genetic_algorithm(key_length=3, number_of_generations=5, cipher_text=web_txt_3))